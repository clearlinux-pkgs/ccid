...
Source0  : https://ccid.apdu.fr/files/ccid-1.6.1.tar.xz
Source1  : https://ccid.apdu.fr/files/ccid-1.6.1.tar.xz.asc
...
%setup -q -n ccid-1.6.1
cd %{_builddir}/ccid-1.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720460247
