...
Version  : 1.4.36
Release  : 10
URL      : https://ccid.apdu.fr/files/ccid-1.4.36.tar.bz2
Source0  : https://ccid.apdu.fr/files/ccid-1.4.36.tar.bz2
Source1  : https://ccid.apdu.fr/files/ccid-1.4.36.tar.bz2.asc
...
%prep
%setup -q -n ccid-1.4.36
cd %{_builddir}/ccid-1.4.36
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630341252
...
cp %{_builddir}/ccid-1.4.36/COPYING %{buildroot}/usr/share/package-licenses/ccid/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/ccid-1.4.36/src/openct/LICENSE %{buildroot}/usr/share/package-licenses/ccid/f25c7f6146e4ac975b9e0c4fb3936a9af04d437a
cp %{_builddir}/ccid-1.4.36/src/towitoko/COPYING %{buildroot}/usr/share/package-licenses/ccid/207a4f23aeb278d4d863854e3d3787247da1ca43
%make_install
