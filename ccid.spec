...
Source0  : https://ccid.apdu.fr/files/ccid-1.6.0.tar.xz
Source1  : https://ccid.apdu.fr/files/ccid-1.6.0.tar.xz.asc
...
%setup -q -n ccid-1.6.0
cd %{_builddir}/ccid-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720022468
